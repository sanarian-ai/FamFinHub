...
// Period only — no holder toggle (single holder) and no Open/Closed/All filter (the "By vehicle"
// table on Performance already breaks out every account, live and closed, individually — a symbol
// filter would be redundant here in a way it isn't on the blended India rollup).
export type Q = { p?: string };

export function parseQ(params: { [k: string]: string | string[] | undefined }): Q {
