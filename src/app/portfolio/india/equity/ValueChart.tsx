 ...
 * plus net invested. Generalized over engine.ts's `bench` record (step 2) instead of the US
 * ValueChart's hardcoded SPY/QQQ keys, since India benchmarks against 2 indices, not a fixed pair. */
