...
/** Portfolio value vs what the same INR flows would be worth in Nifty 50 TRI, plus net invested.
 * Mirrors india/equity/ValueChart.tsx's generalized-over-benchmarks shape. */
