...
/** BTC/ETH quantities need more precision than fmtUnits' 4dp (a 0.00476 BTC lot would round to
 * 0.0048) — 8dp matches satoshi-level precision, trimmed of trailing zeros for readability. */
export function fmtCrypto(x: number): string {
  return x.toLocaleString("en-US", { maximumFractionDigits: 8, minimumFractionDigits: 0 });
}
