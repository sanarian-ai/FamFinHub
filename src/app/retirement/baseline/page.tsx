      ...
      <Card>
        <div className="mb-2 flex flex-wrap items-baseline justify-between gap-2">
          ...
          <span className="text-xs text-slate-500">
            A separate, informational view — not fed into the plan&apos;s compute(). International equity, PMS, mutual funds (split Equity/Debt/Hybrid/Commodity), EPF + NPS, NSE's own listed shares, and Indian direct equity (IIFL) are live; everything else is manual.
          </span>
        </div>
        <table className="w-full text-sm">
          <thead>
